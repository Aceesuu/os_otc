...
$row=mysqli_fetch_array($result);
    ...
    if (isset($_POST['submit'])) {
        ...
        $fn = $_POST['FirstName']; //galing sa input tag sa name
        $mn = $_POST['MiddleName']; //galing sa input tag sa name
        $co = $_POST['Course']; //galing sa input tag sa name
        $yr = $_POST['YearLevel']; //galing sa input tag sa name
        $sub = $_POST['Subject']; //galing sa input tag sa name
        $sec = $_POST['Section']; //galing sa input tag sa name
        $add = $_POST['Address']; //galing sa input tag sa name
        $con = $_POST['ContactNo']; //galing sa input tag sa name
